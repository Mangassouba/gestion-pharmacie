        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="detailsModalLabel">Batch Details</h5>
            ...
            <div class="modal-body">
              <form>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="quantity" :value="selectedBatch?.quantity" disabled>
                </div>
                <div class="mb-3">
        ...
        <tbody>
          <tr v-for="(batch, index) in paginatedbatches" :key="batch.id">
            ...
            <td class="text-center">
              ...
              <!-- <router-link :to="{ name: 'editbatch', params: { id: batch.id }}"
              ...
              <button
                class="btn btn-info btn-sm me-2" @click="openModal(batch)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
