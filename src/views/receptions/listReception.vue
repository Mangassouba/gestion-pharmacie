<template>
    <div class="container mt-4">
      ...
      <table class="table table-striped table-bordered mt-4 mb-4">
        ...
        <tbody>
          <tr v-for="(order, index) in paginatedFilteredReceptions" :key="order.id">
            <td>{{ order.id }}</td>
            ...
            <td class="text-center">
              ...
              <!-- <router-link :to="{ name: 'editProduct', params: { id: order.id }}"
              ...
              <button
                class="btn btn-info btn-sm me-2" @click="openModal(order)"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
