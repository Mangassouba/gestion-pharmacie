      ...
      <div class="row d-flex mt-4">
        ...
        <div class="col-6">
          <div class="d-flex justify-content-end">
            <RouterLink to="/customer/add" class="btn btn-primary">Add Customer</RouterLink>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <div class="mb-3">
                  <label for="customerName" class="form-label">Fist Name</label>
                  <input type="text" class="form-control" id="customerName" :value="selectedcustomer?.firstName" disabled>
                </div>
                <div class="mb-3">
                  <label for="customerDescription" class="form-label">Last name</label>
                  <input type="text" class="form-control" id="customerDescription" :value="selectedcustomer?.lastName" disabled>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="customerSalePrice" :value="selectedcustomer?.phone" disabled>
                </div>
